...
| `MAX_ITEMS_PROCESSED_PER_RUN` | `sync` commands, `run` | Optional. Maximum Sonarr or Radarr sync targets processed per command invocation. Defaults to `30`. Plex collection reads still load the full collection. |
